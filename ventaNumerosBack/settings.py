"""
Django settings for ventaNumerosBack project.
...
ALLOWED_HOSTS = ['ventanumerosback.onrender.com',"ventanumerosfront.onrender.com"]
...
ROOT_URLCONF = 'ventaNumerosBack.urls'
